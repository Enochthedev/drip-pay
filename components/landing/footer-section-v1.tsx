...
export default function FooterSection() {
  return (
    <footer className="bg-midnight_navy text-ghost_white border-t border-slate-700">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          <div className="flex flex-col items-center md:items-start">
            ...
            <span className="text-xs bg-electric_indigo/80 text-ghost_white px-3 py-1 rounded-full font-medium">
              Launching on Swell
            </span>
          </div>
