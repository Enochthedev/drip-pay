...
const features = [
  ...
  {
    icon: <Layers className="h-8 w-8 text-drip_teal" />,
...
export default function WhyDripPaySection() {
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-ghost_white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-slate_gray text-center mb-12 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <Card className="bg-white border-slate-200 hover:border-electric_indigo/50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 h-full">
