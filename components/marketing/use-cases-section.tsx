  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-slate-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 sm:gap-x-8 gap-y-4 sm:gap-y-6 max-w-4xl mx-auto">
          {useCases.map((useCase) => (
            ...
            >
              ...
              <p className="text-slate_gray text-sm sm:text-base lg:text-lg font-sans">{useCase}</p>
            </div>
          ))}
        </div>
      </div>
