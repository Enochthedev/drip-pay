...
export default function EcosystemSection() {
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-slate-50">
      {" "}
      {/* Consistent with UseCases section bg */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-midnight_navy">
        ...
        <p className="text-base sm:text-lg text-slate_gray mb-6 sm:mb-8 max-w-xl mx-auto font-sans">
